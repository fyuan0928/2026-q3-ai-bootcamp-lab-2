...
- [UI Guidelines](../docs/ui-guidelines.md) - UI/UX guidelines for the application
- [Testing Guidelines](../docs/testing-guidelines.md) - Testing principles and conventions for the application
- [Coding Guidelines](../docs/coding-guidelines.md) - Coding style and quality principles for the application
